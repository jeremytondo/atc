...
public struct AtelierCodeAction: Codable, Sendable, Hashable, Identifiable {
...
public struct ActionWriteRequest: Codable, Sendable, Hashable {
    ...
    /// positional prompt.
    public var prompt: AtelierCodeAction.PromptSpec?
    public var params: [String: AtelierCodeAction.ParamSpec]?
    public var enabled: Bool?
    ...
    public init(
        ...
        command: String,
        args: [String]? = nil,
        prompt: AtelierCodeAction.PromptSpec? = nil,
        params: [String: AtelierCodeAction.ParamSpec]? = nil,
        enabled: Bool? = nil
    ) {
        self.name = name
        self.label = label
