...
/// The interface the app depends on for all Atelier Code REST calls.
/// `HTTPAtelierCodeClient` is the real implementation; previews and tests
/// inject mocks.
public protocol AtelierCodeClient: Sendable {
...
public extension AtelierCodeClient {
