...
public extension JSONDecoder.DateDecodingStrategy {
    ...
    static let atelierCodeRFC3339Nano = JSONDecoder.DateDecodingStrategy.custom { decoder in
...
extension JSONDecoder {
    /// Decoder configured for Atelier Code Server responses.
    static func atelierCode() -> JSONDecoder {
        let decoder = JSONDecoder()
        decoder.dateDecodingStrategy = .atelierCodeRFC3339Nano
        return decoder
    }
}
