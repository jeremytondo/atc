...
/// Typed failures from the Atelier Code API.
public enum AtelierCodeError: Error, Sendable {
...
extension AtelierCodeError: LocalizedError {
...
/// Wire format of Atelier Code Server error responses.
