...
const (
	...
	CodePermissionResolved        = "permission_resolved"
	CodePermissionDecisionInvalid = "permission_decision_invalid"
	CodePermissionDecisionFailed  = "permission_decision_failed"
