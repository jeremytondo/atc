...
// classification that follows it, and starting a thread in an
// Integration's program (ATC-289) — composed once here and called from
...
// Integration's program (ATC-289). The record is created, working with
// the submission as its pending turn, before the command is dispatched: the
