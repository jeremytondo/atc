...
public extension JSONDecoder.DateDecodingStrategy {
    ...
    static let cockpitRFC3339Nano = JSONDecoder.DateDecodingStrategy.custom { decoder in
...
extension JSONDecoder {
    /// Decoder configured for Cockpit responses.
    static func cockpit() -> JSONDecoder {
        let decoder = JSONDecoder()
        decoder.dateDecodingStrategy = .cockpitRFC3339Nano
        return decoder
    }
}
