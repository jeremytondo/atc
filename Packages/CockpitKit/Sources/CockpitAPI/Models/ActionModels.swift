...
public struct ActionWriteRequest: Codable, Sendable, Hashable {
    ...
    /// positional prompt.
    public var prompt: CockpitAction.PromptSpec?
    public var params: [String: CockpitAction.ParamSpec]?
    public var enabled: Bool?
    ...
    public init(
        ...
        command: String,
        args: [String]? = nil,
        prompt: CockpitAction.PromptSpec? = nil,
        params: [String: CockpitAction.ParamSpec]? = nil,
        enabled: Bool? = nil
    ) {
        self.name = name
        self.label = label
