...
struct ProjectDecodingTests {
    ...
    func listDecodes() throws {
        let envelope = try JSONDecoder.cockpit().decode(ProjectsEnvelope.self, from: projectsFixture)
    ...
    func singleDecodes() throws {
        let project = try JSONDecoder.cockpit().decode(Project.self, from: projectFixture)
    ...
    func sessionWithProjectDecodes() throws {
        let detail = try JSONDecoder.cockpit().decode(SessionDetail.self, from: sessionWithProjectFixture)
    ...
    func sessionWithoutProjectDecodes() throws {
        let detail = try JSONDecoder.cockpit().decode(SessionDetail.self, from: sessionWithoutProjectFixture)
