...
struct RemoteFolderPickerSheet: View {
    ...
    init(client: any AtelierCodeClient, initialPath: String = "", onChoose: @escaping (String) -> Void) {
...
#Preview("Default directory") {
    RemoteFolderPickerSheet(client: MockAtelierCodeClient()) { _ in }
        .preferredColorScheme(.dark)
}

#Preview("Directory") {
    RemoteFolderPickerSheet(client: MockAtelierCodeClient(), initialPath: "/home/dev/Projects/atelier") { _ in }
        .preferredColorScheme(.dark)
}

#Preview("Prefill error") {
    RemoteFolderPickerSheet(client: MockAtelierCodeClient(), initialPath: "/home/dev/Projects/secrets") { _ in }
        .preferredColorScheme(.dark)
}

#Preview("Truncated") {
    RemoteFolderPickerSheet(client: MockAtelierCodeClient(), initialPath: "/home/dev/Projects/huge") { _ in }
        .preferredColorScheme(.dark)
}

#Preview("Empty folder") {
    RemoteFolderPickerSheet(client: MockAtelierCodeClient(), initialPath: "/home/dev/Projects/empty") { _ in }
        .preferredColorScheme(.dark)
}
