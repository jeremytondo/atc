...
struct ConnectionsSettingsView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("This removes the connection from AtelierCode only. Its Projects and Terminal Sessions remain on the Atelier Code server.")
        }
    }
    ...
    private var detail: some View {
        if let target {
            ...
            ContentUnavailableView {
                ...
                Text("Add a connection to an Atelier Code server to see its projects and sessions in AtelierCode.")
            } actions: {
...
private struct ConnectionEditorView: View {
    ...
    private func testConnection() {
        ...
        testState = .testing
        Task {
            let client = HTTPAtelierCodeClient(server: AtelierCodeServer(baseURL: url, token: draftToken))
            do {
