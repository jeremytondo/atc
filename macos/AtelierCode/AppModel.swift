...
final class AppModel {
    ...
    private let clientFactory: (ConnectionRecord) -> any AtelierCodeClient

    init(
        connections: ConnectionsStore? = nil,
        clientFactory: ((ConnectionRecord) -> any AtelierCodeClient)? = nil
    ) {
    ...
    /// Projects and Sessions remain on the Atelier Code server.
