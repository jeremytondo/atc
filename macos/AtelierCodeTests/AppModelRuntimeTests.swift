...
private nonisolated final class ScriptableClient: AtelierCodeClient, @unchecked Sendable {
    ...
    private func gate() async throws {
        ...
        if shouldFail {
            throw AtelierCodeError.api(code: "unreachable", message: "scripted failure", sessionID: nil)
        }
    }
    ...
    func actions() async throws -> [AtelierCodeAction] { try await gate(); return try await inner.actions() }
